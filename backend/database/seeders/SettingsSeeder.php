...
class SettingsSeeder extends Seeder
{
    ...
    {
        $settings = [
            ['key' => 'site.name', 'group' => 'general', 'value' => 'TravelCash', 'type' => 'string', 'is_public' => true],
            ['key' => 'site.tagline', 'group' => 'general', 'value' => 'Travel more. Pay less. Earn cashback on every trip.', 'type' => 'string', 'is_public' => true],
            ['key' => 'site.support_email', 'group' => 'general', 'value' => 'support@travelcash.test', 'type' => 'string', 'is_public' => true],
            ...
            ['key' => 'seo.meta_description', 'group' => 'seo', 'value' => 'Compare flights, hotels, trains, cabs & packages. Book through TravelCash and earn real cashback.', 'type' => 'string', 'is_public' => true],
        ];
